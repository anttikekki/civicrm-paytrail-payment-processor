/**
* Paytrail payment processor extension admin screen logic. All HTML elements are created by this 
...
cj(function ($) {
  ...
  */
  function startInitDataAjaxLoading() {
    $.ajax({
      dataType: "json",
      url: CRM.paytrail.getInitDataAjaxURL,
  ...
  */
  function createGUI() {
    var container = $('#paytrailAdminContainer');
  ...
  */
  function createEditForm() {
    var html = '<div id="paytrailAdmin_editFormContainer" class="crm-block crm-form-block" style="display: none;">';
    html += '<form>';
  ...
  */
  function createConfigTableContainer() {
    var html = '<div id="paytrailAdmin_configTableContainer">';
  ...
  */
  function reloadConfigAjax(callback) {
    $.ajax({
      dataType: "json",
      url: CRM.paytrail.getConfigAjaxURL,
      success: callback 
    });
  }
  ...
  */
  function updateConfigTable() {
    reloadConfigAjax(function(result) {
      configRows = result;
      $('#paytrailAdmin_configTableContainer').html(createConfigTable());
      initTableEditLinkListeners();
    });
  }
  ...
  */
  function createConfigTableRow(index, configKey, configValue) {
    ...
    html += '  <a class="delete_link" href="#" data-config_key="' + configKey + '">Back to default</a>';
    html += ' </td>';
    html+= '</tr>';
    return html;
  }
  ...
  */
  function configDeleteLinkClicked(eventObject) {
    ...
    $.ajax({
      url: CRM.paytrail.deleteConfigRowAjaxURL,
      data: data,
      success: function() {
        updateConfigTable();
      }
  ...
  */
  function showEditForm() {
    $('#paytrailAdmin_editFormContainer').show();
  ...
  */
  function hideEditForm() {
    $('#paytrailAdmin_editFormContainer').hide();
  }
  ...
  */
  function saveConfigForm() {
    ...
    $.ajax({
      url: CRM.paytrail.saveConfigRowAjaxURL,
      data: getFormData(),
  ...
  */
  function showServerErrorMessage(message) {
    $('#paytrailAdmin_editFormContainer .crm-submit-buttons').append('<label class="crm-inline-error">' + message + '</label>');
  }
  ...
  */
  function clearServerErrorMessage() {
    $('#paytrailAdmin_editFormContainer .crm-submit-buttons .crm-inline-error').remove();
  }
